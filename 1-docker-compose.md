...
docker compose up -d
```
![image](https://github.com/user-attachments/assets/79db7a6e-c758-4cea-9b0a-0dcc17041f47)
...
docker compose ps
```
![image](https://github.com/user-attachments/assets/dab1a563-2d3c-4ee5-be10-dcd1256241b0)
